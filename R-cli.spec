...
Version  : 2.0.0
Release  : 29
URL      : https://cran.r-project.org/src/contrib/cli_2.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/cli_2.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575998298
