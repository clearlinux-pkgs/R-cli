...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/cli_3.6.5.tar.gz
...
%package dev
Summary: dev components for the R-cli package.
Group: Development
Requires: R-cli-lib = %{version}-%{release}
Provides: R-cli-devel = %{version}-%{release}
Requires: R-cli = %{version}-%{release}

%description dev
dev components for the R-cli package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745441888
...
/usr/lib64/R/library/cli/exec/news.R
/usr/lib64/R/library/cli/exec/outdated.R
/usr/lib64/R/library/cli/exec/search.R
/usr/lib64/R/library/cli/exec/up.R
...
/usr/lib64/R/library/cli/tests/testthat/_snaps/rlang-1.1.4/rlang-errors.md
/usr/lib64/R/library/cli/tests/testthat/_snaps/rlang-1.1.6/rlang-errors.md
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/cli/libs/cli.so
/V4/usr/lib64/R/library/cli/libs/cli.so
