...
Source0  : https://cran.r-project.org/src/contrib/cli_2.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605889733
...
/usr/lib64/R/library/cli/tests/testthat/test-crayonex.R
...
/usr/lib64/R/library/cli/tests/testthat/test-unicode.R
