...
Version  : 3.6.2
Release  : 77
URL      : https://cran.r-project.org/src/contrib/cli_3.6.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/cli_3.6.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702500637
